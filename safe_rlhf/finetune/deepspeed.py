...
from safe_rlhf.finetune.trainer import (
    SupervisedFinetuneTrainer,
    SupervisedFinetuneTrainerWithFilter,
    SupervisedFinetuneTrainerWithPeerLoss
)
...
def parse_arguments() -> argparse.Namespace:
    ...
    training_parser.add_argument(
        ...
        type=float,
        default=0.,
        help='The coefficient for peer term.'
    )
...
def main() -> None:
    ...
    trainer = SupervisedFinetuneTrainerWithPeerLoss(args, ds_config)
    trainer.train()
    trainer.save()
